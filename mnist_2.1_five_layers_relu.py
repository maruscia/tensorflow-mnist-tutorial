...
#        · · ·                                                      Y4 [batch, 30]
#         \x/               -- fully connected layer (relu)      W5 [30, 10]        B5[10]
#          ·                                                        Y5 [batch, 10]
...
# final test accuracy = 0.9788 (sigmoid - slow start (especially with GradientDescentOptimizer), training cross-entropy not stabilised in the end)
